      ...
      <div className="soundContainer">
        ...
        <div className="col2">
          <div className="picRow1">
            <div><img className="soundPic" src={nikedance} alt="Nike_Dance"/></div>
            <div><img className="soundPic" src={nikedance} alt="Nike_Dance"/></div>
            <div><img className="soundPic" src={allforyou} alt="All_for_you"/></div>
          </div>
          <div className="picRow2">
            <div><img className="soundPic" src={heatrdy} alt="Heat_RDY"/></div>
            <div><img className="soundPic" src={guidomaria} alt="Guido_Maria"/></div>
            <div><img  className="soundPic" src={danfox} alt="Dan_FOX"/></div>
          </div>
